        ...
        <div className="flex-1 p-6 md:p-8 lg:p-10 flex flex-col relative bg-card/50 backdrop-blur-sm">
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full bg-white hover:bg-white/90 text-black font-bold py-4 rounded-full transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer flex items-center justify-center gap-2 text-lg group"
            >
